...
const registerSchema = zod_1.z.object({
    ...
    phone: zod_1.z.string().regex(/^[0-9]{10}$/, 'Invalid phone number').optional(),
...
const updateAvatarSchema = zod_1.z.object({
    avatar: zod_1.z.string().url('Invalid URL format'),
});
const changePasswordAuthSchema = zod_1.z.object({
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/verify-otp', (0, validation_1.validate)(verifyOTPSchema), authController.verifyOTP);
/**
 * @swagger
 * /api/auth/login:
 *   post:
 ...
 *                           type: boolean
 */
router.post('/request-change-password', auth_1.authenticate, authController.requestChangePassword);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Success'
 */
router.post('/change-password', auth_1.authenticate, (0, validation_1.validate)(changePasswordSchema), authController.changePassword);
/**
 * @swagger
 * /api/auth/profile:
 *   get:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/profile', auth_1.authenticate, (0, validation_1.validate)(updateProfileSchema), authController.updateProfile);
/**
 * @swagger
 * /api/auth/avatar:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/avatar', auth_1.authenticate, (0, validation_1.validate)(updateAvatarSchema), authController.updateAvatar);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/change-password-auth', auth_1.authenticate, (0, validation_1.validate)(changePasswordAuthSchema), authController.changePasswordAuth);
/**
 * @swagger
 * /api/auth/logout:
 *   post:
